...
write_csv(SIF, file = paste("results/",paste(cell_line, "no_compress_SIF.csv",sep = ""), sep = ""))
write_csv(ATT, file = paste("results/",paste(cell_line, "no_compress_ATT.csv",sep = ""), sep = ""))
