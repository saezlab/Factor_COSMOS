...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Preparing_MOFA_input-1.png)

    hist(RNA_sd[1:6000], breaks = 100)

![](MOFA_to_COSMOS_files/figure-markdown_strict/Preparing_MOFA_input-2.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Preparing_MOFA_input-3.png)

    hist(proteo_sd[1:round(dim(proteo)[1]*3/5)], breaks = 100)

![](MOFA_to_COSMOS_files/figure-markdown_strict/Preparing_MOFA_input-4.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Preparing_MOFA_input-5.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Supp_figure_condition_prot_RNA_correlation-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Supp_figure_single_prot_RNA_correlation-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Compare_MOFA_models-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Total_variance_per_factor-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Check_cross_correlation_of_omics_compared_to_variance_epxlained-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Check_cross_correlation_of_omics_compared_to_variance_epxlained-2.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Check_cross_correlation_of_omics_compared_to_variance_epxlained-3.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Variance_per_view_per_factor-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Factor_weights_per_view-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Activity_estimations_for_factor_4-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Activity_estimations_for_factor_4-2.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/correlation_RNA_prot-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Plot_RNA_weights_and_protein_weights-1.png)

    {plot(density(prot_input))
    abline(v = -0.05)
    abline(v = 0.05)}

![](MOFA_to_COSMOS_files/figure-markdown_strict/Plot_RNA_weights_and_protein_weights-2.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Plot_TF_activity_estimates-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Plot_Ligand_receptor_activity_estimates-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Plot_Metabolite_factor_weights-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/Run_moon_rec_to_TFmetab-1.png)
...
![](MOFA_to_COSMOS_files/figure-markdown_strict/run_moon_TF_to_lig-1.png)
